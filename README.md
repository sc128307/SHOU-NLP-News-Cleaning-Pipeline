...
<img src="./screenshots/git_clone.png" width="600" alt="node_version">
...
<img src="./screenshots/env_correct.png" width="500" alt="node_version">
> * ❌ 如果还是 `(base)` 或者没有括号 -> **失败！** 请重新运行上面的激活命令，或者检查 Miniconda 是否安装正确。
> <img src="./screenshots/env_wrong.png" width="450" alt="node_version">
